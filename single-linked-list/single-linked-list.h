...
public:
    ...
    SingleLinkedList(std::initializer_list<Type> values) {
        ...
        tmp.InitializeList(values.begin(), values.end());
        swap(tmp);
    }
    ...
    assert(size_ == 0 && head_.next_node == nullptr);
        SingleLinkedList tmp;
        tmp.InitializeList(other.cbegin(), other.cend());
        swap(tmp);
    }
...
private:
    ...
    void InitializeList(Iterator first, Iterator last) {
        SingleLinkedList<Type> tmp;
        auto node_ptr = &tmp.head_.next_node;
        while(first != last) {
            *node_ptr = new Node(*first, nullptr);
            ++tmp.size_;
